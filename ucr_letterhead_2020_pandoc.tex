...
$else$
\setmainfont[Scale=\mfscale]{EB Garamond}
$endif$
$if(sansfont)$
\setsansfont[$for(sansfontoptions)$$sansfontoptions$$sep$,$endfor$]{$sansfont$}
$else$
\setsansfont[Scale=\mfscale]{Fira Sans}
$endif$
$if(monofont)$
...
\newfontfamily\UCRHeader[
  $for(headerfontoptions)$$headerfontoptions$$sep$,$endfor$
]{$headerfont$}
\newfontfamily\UCRHeaderBold[
...
\fancypagestyle{firstheader}{
  ...
  \fancyhead[R]{
    ...
    \begin{textblock*}$if(secondary-style)${8.5in}(0in, 1.625in)$else${2in}(5.8in, 0.9in)$endif$
      ...
      \textcolor{UCRnavy}{
        $if(department)$\UCRHeaderBold{$department$\hdrsep{}}$endif$
        \UCRHeader{
